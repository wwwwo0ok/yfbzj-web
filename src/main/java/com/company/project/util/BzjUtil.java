...
//        return bitValue == 1 ? "OK" : "取消";
     ...
     */
    public static int parseSeedQuantity(String hexData, int line, int seedEnableStatus) {
    ...
    public static int parseMultiPercentage(String hexData, int line, int seedEnableStatus) {
        if ("取消".equals(seedEnableStatus)) {
            return 0;
        }
...
//        return String.format("%.1f%%", value);
    ...
    public static int parseSowingPercentage(String hexData, int line, int seedEnableStatus) {
        if ("取消".equals(seedEnableStatus)) {
            return 0;
        }
