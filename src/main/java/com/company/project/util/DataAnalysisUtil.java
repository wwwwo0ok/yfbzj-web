...
//TODO			统计肥报警的通道号（1-24高5-9位）和报警号（0-14低4位）共24个记录，12位数,****490-561
	...
	public static DataElectricSeederMessageEntity analysisMachineHexStr(String hexStr) {
...
//        map.put("num77", num77);
	...
	private static List<DataElectricSeederMessageLineEntity> anylisisMachineLineList(String hexStr,int lineCount) {
